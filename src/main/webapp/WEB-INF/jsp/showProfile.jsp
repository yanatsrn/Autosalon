...
<body>
<c:url var="show_profile" value="/showProfile"/>
<div class="wrapper">
    <div class="conteiner">
        <div class="window-users">
            <form:form action="${show_profile}" method="post" modelAttribute="person" class="transparent">
                <div class="title title-reg">Профиль</div>
